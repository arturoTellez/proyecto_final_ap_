    ...
    for epoch in range(epochs):
        ...
        for batch in tqdm(range(n_batchs_tr), desc="Train"):
            ...
            for b in range(batch_size):
                x_train_b[b] = np.load(x_train_paths_b[b], allow_pickle=True)
        ...
        if val_loss >= min_loss + delta:
            ...
            net.save(os.path.join(args.results_path, 'best_modl.h5'))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--multitasking", help="choose resunet-a multitasking \
                        or not", type=str2bool, default=True)
    ...
    parser.add_argument("-rp", "--results_path", help="Path where to save logs and model checkpoint. \
                        ...
                        type=str, default='D:/jorge/Documents/ISPRS/result/results_run1')
    ...
    parser.add_argument("-dp", "--dataset_path", help="Path where to load dataset",
                        type=str, default='D:/jorge/Documents/ISPRS/Potsdam/patch_size=256_stride=128_norm_type=1_data_aug=True')
    ...
    if args.multitasking:
        ...
        patches_tr, patches_val, patches_tr_lb_h, patches_val_lb_h = train_test_split(patches_tr, patches_tr_lb_h, test_size=0.1, random_state=42)
    ...
    if args.multitasking:
        ...
        y_shape_batch = (args.batch_size, args.patch_size, args.patch_size, 6)
